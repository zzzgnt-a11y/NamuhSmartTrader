...
SCRIPT_NAMES=('v352.js','v353_searchfix.js','v355_unified_ui.js')

# One fresh copy of each late UI owner. v354 is intentionally removed because
# its old 50/30/20 timer could overwrite the active 80/20 display.
try:
    text=INDEX.read_text(encoding='utf-8')
    for name in ('v352.js','v353_searchfix.js','v354_scoreui.js','v355_unified_ui.js'):
...
# Remove the old minute/40-60 wording inside the search/universe UI owner as a
# second line of defence; v355 supplies the final live card labels.
try:
