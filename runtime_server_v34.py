...
def _inject(path: str, *, css: bool = True, scripts: tuple[str, ...] = ()):
    ...
    if css:
        ...
        if "/static/v343.css" not in text:
            text = text.replace("</head>", f'  <link rel="stylesheet" href="/static/v343.css?v={asset_version}">\n</head>')
        else:
            text = re.sub(r'(/static/v343\.css)(?:\?v=[^"\']+)?', rf'\1?v={asset_version}', text)
...
_inject("static/index.html", scripts=("/static/v34.js", "/static/v343.js"))
...
_inject("static/stock.html", scripts=("/static/stock-v34.js", "/static/tooltip-v34.js", "/static/v343-chart.js"))
_inject("static/index-detail.html", scripts=("/static/tooltip-v34.js", "/static/v343-chart.js"))
